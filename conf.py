...
BLOG_AUTHOR = "Dan Ball"  # (translatable)
BLOG_TITLE = "danpelota.com"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.danpelota.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.danpelota.com/"
BLOG_EMAIL = "dan@danpelota.com"
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
                    ...
                    ('http://github.com/danpelota', 'github'),
                    # ('/rss.xml', 'RSS'),
                )
}
...
GLOBAL_CONTEXT = {"lanyon_subtheme": "theme-base-0d"}
